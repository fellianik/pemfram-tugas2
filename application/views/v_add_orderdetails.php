...
<body>
    ...
    <div class="container mt-5">
        <form action="<?php echo base_url() ?>index.php/Orderdetails/createData" method="post">
            <div class="row">
                <div class="col">
                    <div class="mb-3 row">
                        <label for="orderNumber" class="col-sm-3 col-form-label">Order Number</label>
                        <div class="col-sm-9">
                            <select name="orderNumber" class="form-select">
                                <option selected>Pilih</option>
                                <?php foreach ($orders as $item) : ?>
                                    <option value="<?php echo $item->orderNumber ?>">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <select name="productCode" class="form-select">
                                <option selected>Pilih</option>
                                <?php foreach ($products as $item) : ?>
                                    <option value="<?php echo $item->productCode ?>">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" name="quantityOrdered">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" name="orderLineNumber">
                        </div>
                    </div>
                </div>

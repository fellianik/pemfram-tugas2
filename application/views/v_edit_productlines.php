...
<body>
    ...
    <div class="container mt-5">
        <form action="<?php echo base_url() ?>index.php/Productlines/update" method="post">
            <div class="row">
                <div class="col">
                    <div class="mb-3 row">
                        <label for="productLine" class="col-sm-3 col-form-label">Product Line</label>
                        <div class="col-sm-9">
                            <input type="text" disabled class="form-control" name="productLine" value="<?php echo $result->productLine; ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="textDescription" class="col-sm-3 col-form-label">Text Description</label>
                        <div class="col-sm-9">
                            <textarea class="form-control" rows="10" name="textDescription"><?php echo $result->textDescription; ?></textarea>
                        </div>
                    </div>
                </div>
